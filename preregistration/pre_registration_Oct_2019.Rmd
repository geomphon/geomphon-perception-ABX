...
3) French speaking participants will also be recruited through an email list ("RISC") and the Facebook groups that focus on recruiting subjectsfor linguistics and Psychology research.  Speakers recruited through email and Facebook will not be paid. 
...
4) They indicate they have high proficiency in another language  **(They answer ___ to the question ___)
5) they indicate they have high experience in another language  (They answer ___ to the question ___)  
6) they indicate they have both medium proficiency and medium experience in another language  
7) DECISION: INCLUDE THIS?Their performance is not significantly different from chance, as determined by___  
8) DECISION: INCLUDE THIS? Their performance is not significantly different from ceiling, as determined by___ 
9) DECISION: INCLUDE THIS? Participant has NA/no data for >3 trials (for any reason, e.g.user error, unanticipated technical error)
...
#### random effects structure 
 ...
 There are several ways that we could define item.  We choose **__THIS WAY_**
