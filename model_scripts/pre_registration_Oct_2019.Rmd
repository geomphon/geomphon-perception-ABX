...
rememember that these are differences, not raw scores. Also, these scores are 
...
To this end, we use comparison of leave-one-out-cross valitation ("loo") scores with varying priors. 
