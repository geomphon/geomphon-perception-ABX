...
data_pos_vars<-
  ...
  df_mods$m_stanfile<-dplyr::case_when(df_mods$m_pos_vars=="none"~ "stan_models/master_neg.stan",
                                     df_mods$m_pos_vars=="econ_glob_loc"~ "stan_models/master_pos.stan",
                                     df_mods$m_pos_vars!="econ_glob_loc"& df_mods$m_pos_vars!="none"~"stan_models/master_model.stan"
                                     )
# model_data_name<-paste("econ_",df_mods$d_coef_econ,
...
#                             )
  ...
  # #create csv name 
  # df_mods$csv_filename<-paste("econ_",df_mods$d_coef_econ,
  #                                 "_loc_",df_mods$d_coef_loc,
  #                                 "_glob_",df_mods$d_coef_glob,
  #                                 ".csv", sep=""
  #                             )
